import { Button, Grid, Typography, Box, Accordion, AccordionSummary, AccordionDetails, Card, CardContent} from '@material-ui/core';
          ...
          <CardContent className={classes.card}>
            <Grid container spacing={7} className={classes.wrap}>
              <Grid item sm={3}>
                ...
                <Button className={classes.btn}  startIcon={<Email />} variant='outlined' href={'mailto:support@wepaygh.com&subject=SendMail&body=Hello'} fullWidth>Email</Button>
